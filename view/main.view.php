  ...
  <body>
    ...
    <div id="milieupage">
      <ul id="triage">
  	     <li><p>Trier par :</p>
  		       <ul>
  			          <li><a href="../controler/main.ctrl.php?onglet=<?=$onglet?>& Trier=prix<?=$param ?>">Prix Croissant</a></li>
  			          <li><a href="../controler/main.ctrl.php?onglet=<?=$onglet?>& Trier=prix DESC<?=$param ?>">Prix Décroissant</a></li>
  		      </ul>
  	    </li>
      </ul>
      ...
      <?php
        for ($i=0; $i <count($list) ; $i++) {
          ...
          $titre=$jeu[1];
          echo "<a href=\"../controler/jeu.ctrl.php?id=$jeu[0]$param\"><img src=$chemin/$img[1] alt=\"\" width=\"240px\" height=\"280px\"> <p>$titre</p> <p id=\"prix\">$jeu[2]€</p> </a>";
        }
       ?>
    </div>
    <div id="baspage">
